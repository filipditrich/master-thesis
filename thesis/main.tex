...
%% - [] NOTE: "Out of total of 145 sale points, the best place was undeniable the L20 PIVNÍ STAN 1" - tady jsem se rozesmál. Je to důležité, ale zároveň naprosto samozřejmé zjištění.
...
%% - [🟠] Figure 2.3: Remaining Chip Balances Sankey Diagram                 -- not readable, small font
%% - [🔴] Figure 2.4: Breakdown of Direct Revenue Streams                    -- ugly pie
%% - [🔴] Figure 2.5: Breakdown of All Revenue Streams                       -- ugly pie
%% - [🟠] Figure 2.6: Overall Cash Flow Diagram                              -- good, just improve coloring and maybe fonts
%% - [🔴] Figure 2.7: Transactions Processing Peaks                          -- small fonts, not readable
%% - [🔴] Figure 2.8: Transaction Processing Peaks                           -- TBD
%% - [🔴] Figure 2.9: Best Top-Up Points                                     -- TBD
%% - [🔴] Figure 2.10: Best Products by Category                             -- TBD
%% - [🟠] Figure 2.11: Returnable Cups                                       -- better labels, not readable
%% - [🔴] Figure 2.12: Most Consumed Beer Brands                             -- TBD
%% - [🟢] Figure 2.13: Visitor Arrival Patterns  							 -- not readable, small labels re-DO
%% - [🟢] Figure 2.14: Credit Top-up Patterns During Event                   -- small labels, not readable, re-DO
%% - [🔴] Figure 2.15: Customer Distribution by Type         		         -- TBD
%% - [🔴] Figure 2.16: Customer App Usage.   							     -- TBD
%% - [🟠] Figure 2.17: Bank Refunds Distribution                             -- improve
%% - [🟠] Figure 2.18: Card Schemes Distribution                             -- adjust but other than that hopefully ok
%% - [🔴] Figure 2.19: Top-up Behavior Analysis                              -- TBD, re-DO
%% - [🟢] Figure 2.20: Beverage Preferences Throughout the Day               -- hopefully OK
%% - [🟢] Figure 2.21: Product Combinations (Including Returnable Cups)      -- hopefully OK
%% - [🟢] Figure 2.22: Product Combinations (Exlucing Returnable Cups)       -- hopefully OK
