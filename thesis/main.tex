...
% TODO (HIGH prio):
%% - [] check what year should be display (24 or 25)
%% - [] submit hard title for printing
...
%%%%% ------------------------------------------------------------
\begin{document}
%%% ⏳ hard cover | TODO: Check year and masters/diploma wording
	% FIXME: remove
	\include{pages/hard-cover}
%%% ⏳ cover page | TODO: check year and masters/diploma wording
	\include{pages/cover}
...
%%% ⏳abstract | TODO: Wait for final revisions, update if necessary
