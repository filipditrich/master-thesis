...
% TODO (HIGH prio):
%% - [] check for overfull boxes, final revision
%% - [] submit for printing
%% - [] FINAL EXPORT FILES PREPARATION - finish up dashboard implementation, prepare to submission format

% TODO (DONE):
%% - [x] prepare the Extended Summary
%% - [x] copy of assignment is not needed
%% - [x] first numbered page is after TOC
%% - [x] revise all figures, tables, and charts - content correctness, graphical finalization, alignment, etc.
%% - [x] RQ03 remaining balances sankey diagram -> replace/or add funnel chart? if time allows
%% - [x] higher-quality screenshots of dashboard sections
%% - [x] higher-quality PDFs of all charts and figures
...
%	\include{pages/hard-cover}
%%% ✅ Cover page
	\include{pages/cover}
%%% copy of the assignment - NOT NEEDED
%	\includepdf[pages={1}]{\ThesisFigures/assignment-copy-draft.pdf}
%	\includepdf[pages={2}]{\ThesisFigures/assignment-copy-draft.pdf}
%%% ✅ Declaration
...
%%% ✅ Table of Contents
	...
	\pagestyle{empty}
	\tableofcontents
	% force empty style for all TOC pages
	\addtocontents{toc}{\protect\thispagestyle{empty}}
	\clearpage
%%% ✅ Chapter
	% reset page numbering and style
	\pagestyle{plain}
