...
\definecolor{chart1}{HTML}{6C969D}
\definecolor{chart2}{HTML}{97CC04}
\definecolor{chart3}{HTML}{2D7DD2}
\definecolor{chart4}{HTML}{EEB902}
\definecolor{chart5}{HTML}{474647}
\definecolor{chart6}{HTML}{F45D01}
\definecolor{chart7}{HTML}{9B6B6C}
\definecolor{chart8}{HTML}{556F44}
...
\NewDocumentCommand{\rqfull}{m}{
	\hyperref[rq:#1]{
		\textbf{\csname rqlabel:\string#1\endcsname}: \rqtext{#1}
	}
}
...
\renewcommand{\therqcounter}{\arabic{rqcounter}}