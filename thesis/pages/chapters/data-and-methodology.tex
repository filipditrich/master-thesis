...
This function was constructed in a way, where it supports time-based filtering and provides extensive insights into the customers, which is shown in table~\ref{tab:chip-customers-columns}~below:
...
For better understanding and visualization of this initial comprehensive Knowledge Data Discover process, a simplified diagram was created; that can be seen in figure~\ref{fig:data-methodology-diagram}.
