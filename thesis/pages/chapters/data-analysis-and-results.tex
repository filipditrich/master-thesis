...
\begin{rqbox}
	\researchq{cashflow-top-up-balance}
\end{rqbox}
...
\begin{rqbox}
	\researchq{cashflow-total-sales}
\end{rqbox}
...
\begin{rqbox}
	\researchq{cashflow-remaining-balance}
\end{rqbox}
...
\begin{rqbox}
	\researchq{cashflow-total-revenue}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-transactions}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-processing-during-peaks}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-delays-downtimes}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-best-top-up-points}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-best-sale-points}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-best-vendors}
\end{rqbox}
...
\begin{rqbox}
	\researchq{performance-best-products}
\end{rqbox}
...
\begin{rqbox}
	\researchq{beverage-returnable-cups}
\end{rqbox}
...
\begin{rqbox}
	\researchq{beverage-total-consumption}
\end{rqbox}
...
\begin{rqbox}
	\researchq{beverage-popular-category}
\end{rqbox}
...
\begin{rqbox}
	\researchq{beverage-top-non-alcoholic}
\end{rqbox}
...
\begin{rqbox}
	\researchq{beverage-top-alcoholic}
\end{rqbox}
...
The analysis addresses the remaining twelve research questions, which have been reorganized into four logical groups to improve the narrative flow:
\begin{enumerate}
...
\begin{rqbox}
	\researchq{customers-total-attendance}
\end{rqbox}
...
\begin{rqbox}
	\researchq{customers-new-visitors}
\end{rqbox}
...
\begin{rqbox}
	\researchq{customers-visitor-time}
\end{rqbox}
...
\begin{rqbox}
	\researchq{customers-top-up-peaks}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq23-topup-patterns}
...
\begin{rqbox}
	\researchq{customers-top-up-online}
\end{rqbox}
...
\begin{rqbox}
	\researchq{customers-distribution-types}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq28-customer-distribution}
...
\begin{rqbox}
	\researchq{customers-mobile-app}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq29-customer-app-usage}
...
% TODO
\begin{rqbox}
	\researchq{customers-bank-cards}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq19-bank-refunds}
...
\begin{rqbox}
	\researchq{customers-card-schemes}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq20-card-schemes}
...
\begin{rqbox}
	\researchq{customers-top-up-more-than-once}
\end{rqbox}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.99\textwidth]{\ResultsDir/rq24-top-up-behavior}
...
% TODO
\todo{Temporal analysis of drink preferences, Product combination analysis, Purchase behavior insights}
% TODO
\begin{rqbox}
	\researchq{customers-drink-preferences}
\end{rqbox}
% TODO
\begin{rqbox}
	\researchq{customers-common-combinations}
\end{rqbox}