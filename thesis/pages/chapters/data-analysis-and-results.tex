...
\begin{section}{Performance Indicators Analysis}
	...
	% @formatter:on
		...
		\begin{subsubsection}{Best Sale Places}
			...
			Out of the total of~\bfmtnum{145}~sale places, the best place was undeniably the \textbf{L20 PIVNÍ STAN 1} with a total of~\bfmtnum{10114}~orders processed and the maximum peak of~\bfmtnum{840}~orders per hour.
