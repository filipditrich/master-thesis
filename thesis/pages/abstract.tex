...
\nobreak\vbox to 0.49\vsize{
	...
	\textit{Keywords: festival data analytics, cashless payments, data visualization, interactive dashboard}
	\vss}
...
\vbox to 0.5\vsize{
	...
	\textit{Klíčová slova: analýza dat z festivalu, bezhotovostní platby, vizualizace dat, interaktivní dashboard}
	\vss}
